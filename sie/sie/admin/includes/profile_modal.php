    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Perfil del Empleado</b></h4>
          	</div>
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="profile_update.php?return=<?php echo basename($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data">
          		  <div class="form-group">
                  	...
                  	<div class="col-sm-9">
                    	<input disabled type="text" class="form-control" id="username" name="username" value="<?php echo $user['document']; ?>">
                  	</div>
                </div>
                <div class="form-group">
              ...
              <button type="button" class="btn btn-danger  pull-left" data-dismiss="modal"><i class="bi bi-bookmark-x"> Cerrar</i></button>
              <button type="submit" class="btn btn-success btn-flat" name="save"><i class="bi bi-bookmark-check"> Guardar</i></button>
            	</form>
          	</div>
        </div>
    </div>
