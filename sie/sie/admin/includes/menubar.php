      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="list-group"><a href="employee.php"><i class="fa fa-circle-o"></i> Lista de Empleados</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Tiempo Extra</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Adelanto en Efectivo</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Horarios</a></li>
          </ul>
        </li>
        <li><a href=""><i class="fa fa-file-text"></i> Deducciones</a></li>
        <li><a href="position.php"><i class="fa fa-suitcase"></i> Cargos</a></li>
        <li class="header">IMPRIMIBLES</li>
        <li><a href=""><i class="fa fa-files-o"></i> <span>Nómina</span></a></li>
