                ...
                <tbody>
                  <?php
                   $documento = $user['document'];
                    $sql = "SELECT *, cashadvance.id AS caid, employees.id_employee AS empid FROM cashadvance LEFT JOIN employees ON employees.id_employee=cashadvance.employees_id  WHERE employees.document = $documento";
                    ...
                    while($row = $query->fetch_assoc()){
                      echo "
                        <tr>
                          <td class='hidden'></td>
                          <td>".$row['caid']."</td>
                          <td>".date('d M, Y', strtotime($row['date_advance']))."</td>
